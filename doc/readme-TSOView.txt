...
　Shift+↓キー：選択フィギュアをZ軸方向に移動
　Shift+←キー：選択フィギュアをX軸方向に移動
　Shift+→キー：選択フィギュアをX軸方向に移動
　Shift+Page Upキー：選択フィギュアをY軸方向に移動
　Shift+Page Downキー：選択フィギュアをY軸方向に移動
...
ver 0.3.4 からの変更点：
・テクスチャ読み込みバグを修正
・ポーズセーブとシーンセーブ：カメラとライトを省略できる
・セルフシャドウ復活

ver 0.3.3 からの変更点：
・ポーズセーブとシーンセーブ：カメラとライトに対応

ver 0.3.2 からの変更点：
・フィギュア設定画面にSaveボタンを追加
