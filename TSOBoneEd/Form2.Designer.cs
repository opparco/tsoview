namespace TSOBoneEd
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnTraZ = new TSOBoneEd.NotSelectableButton();
            this.btnTraY = new TSOBoneEd.NotSelectableButton();
            this.btnTraX = new TSOBoneEd.NotSelectableButton();
            this.btnRotZ = new TSOBoneEd.NotSelectableButton();
            this.btnRotY = new TSOBoneEd.NotSelectableButton();
            this.btnRotX = new TSOBoneEd.NotSelectableButton();
            this.SuspendLayout();
            // 
            // lbRot
            // 
